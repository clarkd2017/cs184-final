...
void Plane::collide(PointMass &pm) {
    ...
    collideFace(pm, point + Vector3D(-0.6, 0.0f, 0.0f), Vector3D(1.0f,0.0f,0.0f), friction); //right plane
    collideFace(pm, point + Vector3D(0.6, 0.0f, 0.0f), Vector3D(-1.0f,0.0f,0.0f), friction); //left plane
    collideFace(pm, point + Vector3D(0.0f, 0.0f, -0.6), Vector3D(0.0f,0.0f,1.0f), friction); //front plane
    collideFace(pm, point + Vector3D(0.0f, 0.0f, 0.6), Vector3D(0.0f,0.0f,-1.0f), friction); //back plane
